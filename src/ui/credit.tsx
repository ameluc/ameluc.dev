...
*/
export function Credit(props: BaseProps & CreditProps): ReactElement {
    return (<div id={props.id} className={props.className}>
        <div className={`flex flex-row items-center justify-center gap-1`}>
            <a href="https://www.ameluc.dev">Gallerie Améluc</a>
            <p>{` ${props.localContent.licence.copyrightPart} `}</p>
            <a href="https://www.linkedin.com/in/ameluc/">Améluc Ahognidjè</a>
            <p>{` ${props.localContent.licence.licencePart} `}</p>
